...
class TemplatesApiFeaturesTest < Test::Unit::TestCase
  ...
  def test_features
    ...
    # Proxy::DefaultModuleLoader.any_instance.expects(:load_configuration_file).with('templates.yml').returns(enabled: true, template_url: 'http://smart-proxy.example.com:8000')
